        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 space-y-8 custom-scrollbar">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-sm lg:text-base text-gray-400 font-medium font-dm">Set your working hours and manage time off</p>
            </div>
            <button className="px-8 py-3.5 bg-gradient-purple text-white rounded-lg font-bold font-dm shadow-lg shadow-primary/20 hover:shadow-xl hover:scale-[1.02] duration-300">
              Save Schedule
            </button>
          </div>
            ...
            <div className="xl:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-[32px] border border-gray-100 shadow-logs duration-300 hover:shadow-xl overflow-hidden">
                <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-50">
                  ...
                  <div className="flex items-center gap-3 bg-[#A855F7]/10 px-4 py-2.5 rounded-full self-start sm:self-auto">
                    <span className="text-xs sm:text-sm text-[#4a4452] font-medium font-dm">Set recurring schedule</span>
                    <button
                      onClick={() => setIsRecurring(!isRecurring)}
                      className={clsx(
                        "w-10 sm:w-12 h-5 sm:h-6 rounded-full relative duration-300",
                  ...
                  <table className="w-full min-w-[700px] border-collapse">
                    <thead>
                      <tr className="bg-primary/5">
                        <th className="py-5 px-6 text-[13px] font-black text-gray-400 uppercase tracking-[0.2em] rounded-l-2xl">Day</th>
                                ...
                                <td key={block.id} className="py-6 px-4 border-b border-gray-100">
                                  <div className="flex justify-center">
                                    <button
                                      ...
                                      className={clsx(
                                        "size-11 rounded-full flex items-center justify-center duration-300",
                                        isSelected
                                          ? "bg-gradient-purple text-white shadow-lg shadow-primary/20 scale-100"
          ...
          <div className="relative w-full max-w-lg bg-white rounded-[32px] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <form onSubmit={handleAddTimeOff} className="p-8 space-y-6">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-2 h-14 bg-gradient-purple text-white rounded-2xl font-bold font-dm shadow-lg shadow-primary/20 hover:shadow-xl duration-300"
                >
                  Schedule Time Off
                </button>
              </div>
