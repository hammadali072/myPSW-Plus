          ...
          <div className="p-4 sm:p-8 lg:p-12 pb-24">
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="mb-8 sm:mb-12 lg:mb-16">
                ...
                <p className="text-[11px] sm:text-sm md:text-base lg:text-lg text-text-muted font-medium font-dm leading-relaxed max-w-xl">
                ...
                {CARE_SERVICES.map((service) => {
                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        "w-full group bg-white p-3.5 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border-2 duration-300 flex items-center justify-between transition-all outline-none focus:outline-none",
                        isSelected
                    ...
                    >
                      <div className="flex items-center gap-3 sm:gap-5 min-w-0">
                        <div className={clsx(
                          "size-9 sm:size-11 md:size-14 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 transition-all duration-300",
                          isSelected ? "bg-white text-[#6A0DAD] shadow-sm" : "bg-gray-50 text-gray-400"
                        )}>
                          <service.icon className="size-5 sm:size-6 md:size-8" />
                        </div>
                        <span className={clsx(
                          "text-sm sm:text-base md:text-lg font-bold font-dm transition-colors duration-300 text-left truncate",
                      ...
                      <div className={clsx(
                        "size-5 sm:size-6 md:size-7 rounded-md sm:rounded-lg border-2 flex items-center justify-center transition-all duration-300 shrink-0 ml-3",
                        isSelected
