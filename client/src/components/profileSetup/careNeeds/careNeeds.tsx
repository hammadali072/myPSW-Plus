            ...
            {CareConditionsData.map((condition) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    "px-6 sm:px-10 py-3 rounded-full text-sm sm:text-base font-bold font-dm duration-300 border-2 transition-transform active:scale-[0.98] text-balance",
                    isSelected
            ...
            {CareServicesData.map((service) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    "w-full flex items-center justify-between p-4 sm:p-5 lg:p-6 rounded-xl md:rounded-2xl duration-300 border-2 transition-transform active:scale-[0.99] text-left",
                    isSelected
